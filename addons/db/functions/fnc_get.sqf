 ...
 * ["myKey", myObject, "dragonfly_db_fnc_test", true] call dragonfly_db_fnc_get; (Multiplayer only)
 *
 * Public: Yes
 */
...
if (_key == "") exitWith {
    diag_log text format ["ArmaDragonflyClient: 'dragonfly_db_fnc_get' Invalid Input for Key '%1'", _key];
};
