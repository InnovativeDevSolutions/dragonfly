 ...
 *
 * Example:
 * ["myKey", myObject, "myFunction", true] call dragonfly_db_fnc_hgetall; (Server or Singleplayer only)
 * ["myKey", myObject, "myFunction", true] remoteExec ["dragonfly_db_fnc_hgetall", 2, false]; (Multiplayer only)
 *
 * Public: Yes
 */
