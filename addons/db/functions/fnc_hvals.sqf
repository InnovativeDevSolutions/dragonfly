 ...
 *
 * Example:
 * ["myKey", player, "setVariable", true] call dragonfly_db_fnc_hvals; (Server or Singleplayer only)
 * ["myKey", player, "setVariable", true] remoteExec ["dragonfly_db_fnc_hvals", 2, false]; (Multiplayer only)
 *
 * Public: Yes
 */
