 ...
 * ["myKey", "myField", myObject, "myFunction", true] remoteExec ["dragonfly_db_fnc_hget", 2, false]; (Multiplayer only)
 *
 * Public: Yes
 */
...
if (_field isEqualTo "") exitWith {
    diag_log text format ["ArmaDragonflyClient: 'dragonfly_db_fnc_hget' Invalid Input for Field '%1'", _field];
};
