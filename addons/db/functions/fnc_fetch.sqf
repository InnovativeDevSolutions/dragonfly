...
dragonfly_db_fetch_array pushBackUnique [_uniqueID, _fnc, _index, _total, _datachunk, _call, _obj];
...
if (_count_total == _total) then {
    ...
    #ifdef __A3__DEBUG__
        diag_log text format ["ArmaDragonflyClient: 'dragonfly_db_fnc_fetch' Data: %1", _data];
    #endif
