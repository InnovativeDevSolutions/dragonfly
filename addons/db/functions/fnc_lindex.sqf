 ...
 *
 * Example:
 * ["myKey", 1, objNull, "", false] call dragonfly_db_fnc_lindex; (Server or Singleplayer only)
 * ["myKey", 1, objNull, "", false] remoteExec ["dragonfly_db_fnc_lindex", 2, false]; (Multiplayer only)
 *
 * Public: Yes
 */
...
if (_key == "") exitWith {
    diag_log text format ["ArmaDragonflyClient: 'dragonfly_db_fnc_lindex' Invalid Input for Key '%1'", _key];
};
