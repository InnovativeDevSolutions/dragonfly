...
```sqf
[_key, _index] call dragonfly_db_fnc_lrem
```
...
```sqf
["eventLog", 0] call dragonfly_db_fnc_lrem;
```

**Remove a specific player record:**
```sqf
["playerRecords", 5] call dragonfly_db_fnc_lrem;
```

**Remove an element from a multiplayer environment:**
```sqf
["sharedData", 2] remoteExecCall ["dragonfly_db_fnc_lrem", 2, false];
```
