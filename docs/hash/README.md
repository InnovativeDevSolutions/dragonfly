...
["", "myField", [myValue]] call dragonfly_db_fnc_hset;
["", "myField"] call dragonfly_db_fnc_hget;
[] call dragonfly_db_fnc_hgetall;
["", "myField"] call dragonfly_db_fnc_hrem;

// Set multiple hash fields in one operation
["", ["loadout", [getUnitLoadout player], "position", [getPosASL player], "direction", [getDir player]]] call dragonfly_db_fnc_hmset;

// ID-specific examples
["myKey", "myField", [myValue]] call dragonfly_db_fnc_hset;
["myKey", "myField"] call dragonfly_db_fnc_hget;
["myKey"] call dragonfly_db_fnc_hgetall;
["myKey", "myField"] call dragonfly_db_fnc_hrem;

// Set multiple hash fields in on operation
[getPlayerUID player, ["loadout", [getUnitLoadout player], "position", [getPosASL player], "direction", [getDir player]]] call dragonfly_db_fnc_hmset;
```
